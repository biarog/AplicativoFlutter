...
const List<ThemePreset> kDefaultThemePresets = [
  ...
  ThemePreset(
    ...
    lightTerciary: Color.fromARGB(255, 79, 36, 23),
    lightError: Colors.red,
    darkPrimary: Colors.deepOrange,
    darkSecondary: Color(0xFF5E372B),
    darkTerciary: Color.fromARGB(255, 255, 218, 176),
  ...
  ThemePreset(
    ...
    darkTerciary: Color.fromARGB(255, 200, 255, 200),
    darkError: Colors.red,
  ),
  ThemePreset(
    id: 'yellow',
    name: 'Yellow',
    lightPrimary: Color.fromARGB(255, 255, 235, 59),
    lightSecondary: Color.fromARGB(255, 255, 249, 196),
    lightTerciary: Color.fromARGB(255, 90, 94, 43),
    lightError: Colors.red,
    darkPrimary: Color.fromARGB(255, 185, 222, 0),
    darkSecondary: Color.fromARGB(255, 185, 183, 34),
    darkTerciary: Color(0xFFFFF3B0),
    darkError: Colors.red,
  ),
  ThemePreset(
    id: 'pink',
    ...
    darkTerciary: Color.fromARGB(255, 235, 109, 216),
    darkError: Colors.red,
  ),
  ThemePreset(
    id: 'purple',
    ...
    darkTerciary: Color.fromARGB(255, 118, 39, 192),
    darkError: Colors.red,
  ),
];
...
class ThemeSettingsNotifier extends Notifier<ThemeSettings> {
  ...
  ThemeSettings build() {
    ...
    return ThemeSettings(
      lightPrimary: Colors.orange,
      lightSecondary:  Color(0xFFFADB6E),
      lightTerciary: Color(0xFFFFF3B0),
      lightError: Colors.red,
      darkPrimary: Colors.deepOrange,
      darkSecondary:  Color(0xFF5E372B),
      darkTerciary: Color(0xFF5E372B),
      darkError: Colors.red,
