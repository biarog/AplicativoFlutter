...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get removeAllRoutinesDesc =>
      'Supprimer toutes les routines enregistrées de l\'appareil et du cloud';
  ...
  String get deleteAllRoutinesConfirm =>
      'Êtes-vous sûr de vouloir supprimer toutes les routines enregistrées? Cela ne peut pas être annulé.';
  ...
  String get noRoutinesYet =>
      'Pas encore de routines. Appuyez sur Créer pour ajouter votre première routine.';
  ...
  String get changePasswordNotImplemented =>
      'Dialogue de changement de mot de passe pas encore implémenté.';
  ...
  String get validDurationRequired =>
      'Veuillez entrer une durée valide en secondes';

  @override
  String get validSetsRepsRequired =>
      'Veuillez entrer des séries et répétitions valides';
  ...
  String get atLeastOneExercise =>
      'Veuillez ajouter au moins un exercice à la routine';
  ...
  String get validationError =>
      'Erreur de validation. Veuillez vérifier votre saisie.';
  ...
  String get organizeWeekWorkouts =>
      'Organisez vos entraînements de la semaine';
}
