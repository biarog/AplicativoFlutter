...
import 'package:aplicativo_flutter/widgets/credits_dialog.dart';

@widgetbook.UseCase(name: 'Default', type: CreditsDialog)
Widget buildCreateAccountDialogUseCase(BuildContext context) {
  ...
  return const ProviderScope(child: CreditsDialog());
}