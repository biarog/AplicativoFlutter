...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get removeAllRoutinesDesc =>
      'Remover todas as rotinas salvas do dispositivo e nuvem';
  ...
  String get deleteAllRoutinesConfirm =>
      'Tem certeza de que deseja excluir todas as rotinas salvas? Isso não pode ser desfeito.';
  ...
  String get noRoutinesYet =>
      'Nenhuma rotina ainda. Toque em Criar para adicionar sua primeira rotina.';
  ...
  String get changePasswordNotImplemented =>
      'Diálogo de alteração de senha ainda não implementado.';
  ...
  String get validDurationRequired =>
      'Por favor, insira uma duração válida em segundos';

  @override
  String get validSetsRepsRequired =>
      'Por favor, insira séries e repetições válidas';
  ...
  String get googleSignInError =>
      'Erro no login com Google. Por favor, tente novamente.';

  @override
  String get validationError =>
      'Erro de validação. Por favor, verifique sua entrada.';
